...
const activity = [
  { id: "a1", label: "Premium unlock — Napoli vs Inter", amount: -7.5, date: "Jul 19" },
  { id: "a2", label: "Wallet deposit", amount: 50, date: "Jul 18" },
  { id: "a3", label: "Subscription — aminaodds", amount: -29.99, date: "Jul 15" },
]
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8">
      ...
      <StatCard
        ...
        value={formatCurrency(124.5)}
        icon={WalletIcon}
        description="Pending withdrawals: $40.00"
      />
